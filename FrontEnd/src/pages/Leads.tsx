    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="mx-auto max-w-7xl px-6 py-10">
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div><p className="text-sm font-medium uppercase tracking-wide text-slate-500">Leads Admin</p><h1 className="mt-2 text-4xl font-semibold tracking-tight">Demo request pipeline</h1></div>
