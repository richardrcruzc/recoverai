...
const howItWorks = [
  {
    ...
    body: 'Upload unpaid invoices or connect your workflow so your receivables are centralized in one place.'
  },
  {
    step: '2',
    title: 'Automate follow-ups',
    body: 'Set reminder sequences by aging bucket with email, SMS, and escalation logic.'
  },
  {
    step: '3',
    title: 'Collect faster',
    body: 'Customers receive clear reminders and payment links so they can pay quickly.'
  }
];
...
const pricing = [
  {
    name: 'Starter',
    price: '$49/mo',
    features: ['Up to 250 invoices', 'Email reminders', 'Basic dashboard']
  },
  {
    name: 'Growth',
    price: '$99/mo',
    features: ['Up to 1,000 invoices', 'Email + SMS flows', 'Priority scoring'],
    featured: true
  },
  {
    name: 'Pro',
    price: '$199/mo',
    features: ['Unlimited workflows', 'Advanced reporting', 'Team access']
  },
  {
    name: 'Performance',
    price: '1%–3% recovered',
    features: ['Lower fixed cost', 'Aligned to collected cash', 'Best for higher-volume receivables']
  }
];
...
const faq = [
  {
    ...
    a: 'No. QuickBooks tracks invoices. RecoverAI helps you collect them faster.'
  },
  {
    q: 'Who is this for?',
    a: 'Best for agencies, consultants, IT service firms, and other B2B businesses with recurring invoicing.'
  },
  {
    q: 'How long does setup take?',
    a: 'Early users can be onboarded in less than a day with a simple import and workflow setup.'
  }
];
      ...
      <main>
        <section className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:items-center">
          <div>
            ...
            <h1 className="max-w-2xl text-4xl font-semibold tracking-tight md:text-6xl">
              Stop chasing unpaid invoices. Get paid automatically.
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="#cta" className="rounded-2xl bg-slate-900 px-6 py-3 text-sm font-medium text-white shadow-sm transition hover:opacity-90">
                Book a Demo
              </a>
              <a href="#pricing" className="rounded-2xl border border-slate-300 bg-white px-6 py-3 text-sm font-medium text-slate-900 shadow-sm transition hover:bg-slate-100">
                View Pricing
              </a>
            </div>
              ...
              <div className="rounded-2xl bg-slate-100 p-4">
                ...
                <div className="mt-3 space-y-3">
                  {['Day 3: Friendly email reminder', 'Day 7: SMS follow-up', 'Day 15: Firm payment request', 'Day 30: Final notice + call task'].map((item) => (
                    <div key={item} className="rounded-xl bg-white p-3 text-sm shadow-sm">
                      {item}
                    </div>
                  ))}
                </div>
        ...
        <section id="how" className="mx-auto max-w-7xl px-6 py-20">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
              Launch a repeatable collections process in days, not months.
            </h2>
          </div>
        ...
        <section className="bg-slate-900 text-white">
          <div className="mx-auto max-w-7xl px-6 py-20">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
                This is not invoice tracking. It is a cash recovery engine.
              </h2>
              <p className="mt-5 text-lg leading-8 text-slate-300">
                RecoverAI combines workflows, prioritization, and payment-ready communication so your business can collect faster without more admin overhead.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="pricing" className="mx-auto max-w-7xl px-6 py-20">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
              Simple pricing that pays for itself with one recovered invoice.
            </h2>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {pricing.map((plan) => (
              ...
              >
                ...
                <a
                  href="#cta"
                  className={`mt-8 inline-block rounded-2xl px-5 py-3 text-sm font-medium transition ${plan.featured ? 'bg-white text-slate-900 hover:bg-slate-100' : 'bg-slate-900 text-white hover:opacity-90'}`}
                >
          ...
          <div className="rounded-[2rem] bg-slate-900 p-8 text-white shadow-2xl md:p-12">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-lg leading-8 text-slate-300">
                Book a demo and we’ll show you how to turn overdue invoices into a repeatable cash collection workflow.
              </p>
            </div>
